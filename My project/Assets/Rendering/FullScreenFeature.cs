...
public class FullScreenPostProcess : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class FullScreenPass : ScriptableRenderPass
    {
        ...
        public FullScreenPostProcess.FullScreenPassSettings settings;
        RenderTargetIdentifier colorBuffer, temporaryBuffer;
        private int temporaryBufferID = Shader.PropertyToID("_TemporaryBuffer");

        public FullScreenPass(FullScreenPostProcess.FullScreenPassSettings passSettings)
        {
